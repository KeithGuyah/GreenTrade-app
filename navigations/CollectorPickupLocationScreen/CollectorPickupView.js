...
import { Text, View, FlatList, Button, TouchableOpacity,Dimensions, SafeAreaView} from "react-native";
...
export default class CollectorPickupView extends Component {
  ...
  toggleCamera =() =>{
    this.props.navigation.navigate("CollectorML", userSelected);
  ...
  renderItem = ({ item}) => (
    <TouchableOpacity onPress={() => {
      ...
      //this.toggleMap()
      this.setState({name: item.Name, address: item.Address, date: item.Date, userSelected: true, userSelected: pickupInfo});
      }}>
